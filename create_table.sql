CREATE DATABASE Estate_in_Festa;
...
CREATE TABLE PROGRAMMATI(
	...
	FOREIGN KEY (Codice_Concerto) REFERENCES CONCERTI(Codice_Concerto),
	FOREIGN KEY (Codice_Brano) REFERENCES BRANI(Codice_Brano)
...
CREATE TABLE SCRIVONO(
	...
	FOREIGN KEY(Codice_Autore) REFERENCES AUTORI(Codice_Autore),
	FOREIGN KEY(Codice_Brano) REFERENCES BRANI(Codice_Brano),
	
	ON UPDATE CASCADE,
	ON DELETE SET DEFAULT 'SCONOSCIUTO'
);
...
CREATE TABLE SOLISTI(
	...
	FOREIGN KEY (Matricola) REFERENCES ESECUTORI(Matricola),
...
CREATE TABLE SUONANO(
	...
	FOREIGN KEY(Matricola) REFERENCES ORCHESTRALI(Matricola),
	FOREIGN KEY(Codice_Brano) REFERENCES BRANO(Codice_Brano),
...
CREATE TABLE APPARTENGONO(
	...
	FOREIGN KEY(Codice_Orchestrale) REFERENCES ORCHESTRALI(Codice_Orchestrale),
